...
const cube = new THREE.Mesh(
  new THREE.IcosahedronGeometry(0.1, 16),
...
gui.add({ looAtCube }, 'looAtCube').name('注视')
gui.add({ zoomTo }, "zoomTo").name('详细注视')

const cubeControl = gui.addFolder('立方体控制')
cubeControl.add(cube.position, 'x', -5, 5, 0.1).name('X轴位置')
cubeControl.add(cube.position, 'y', -5, 5, 0.1).name('Y轴位置')
cubeControl.add(cube.position, 'z', -5, 5, 0.1).name('Z轴位置')
cubeControl.open()
