...
function createCircularRing(position, outRadius, inRadius, color) {
  ...
  geometry.setAttribute( 'position', new THREE.BufferAttribute( cube(1, 1, 1), 3 ) );
...
function cube(width, height, depth){
  ...
  const cubeDepth = depth
  const segment = 1
  for(let i = 0; i < segment; i++){
    const point1 = [cubeWidth, i * cubeHeight, 0]
    const point2 = [0, i * cubeHeight + cubeHeight, 0]
    const point3 = [cubeWidth, i * cubeHeight + cubeHeight, 0]
    const point4 = [0, i * cubeHeight, 0]
    const point5 = [cubeWidth, i * cubeHeight, cubeDepth]
    const point6 = [0, i * cubeHeight + cubeHeight, cubeDepth]
    const point7 = [cubeWidth, i * cubeHeight + cubeHeight, cubeDepth]
    const point8 = [0, i * cubeHeight, cubeDepth]
