...
const vertexShaderSource = /*glsl*/`
  ...
  void main() {
    gl_Position = uProjectionMatrix * uModelMatrix * vec4(position, 1);
  }
`
...
modelFolder.add(params, 'xRot', 0, Math.PI * 2).onChange(updateUniforms)
modelFolder.add(params, 'yRot', 0, Math.PI * 2).onChange(updateUniforms)
modelFolder.add(params, 'zRot', 0, Math.PI * 2).onChange(updateUniforms)
