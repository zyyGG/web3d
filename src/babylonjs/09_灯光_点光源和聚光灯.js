...
// 点光源
const pointerLight = new BABYLON.PointLight("pointLight", new BABYLON.Vector3(0, 2, 0), scene);
pointerLight.position = new BABYLON.Vector3(3, 2, 3);
pointerLight.intensity = 1;
pointerLight.diffuse = new BABYLON.Color3(1, 0, 0);
pointerLight.specular = new BABYLON.Color3(0, 1, 0);
pointerLight.range = 5;

// spotlight 聚光灯
const spotLight = new BABYLON.SpotLight("spotLight", new BABYLON.Vector3(-2, 5, -2), new BABYLON.Vector3(0.1, -1, 0.3), Math.PI / 4, 2, scene);
spotLight.diffuse = new BABYLON.Color3(0, 0, 1);
spotLight.specular = new BABYLON.Color3(1, 0, 1);
spotLight.range = 10 // 光照范围
spotLight.exponent = 30; // 光照衰减，也就是光照的强度衰减
