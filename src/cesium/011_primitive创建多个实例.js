...
// 01 创建几何顶点
const geometry01 = new Cesium.CircleGeometry({
  id: "circle01",
  center: Cesium.Cartesian3.fromDegrees(116.0, 42.8, 0.0), // 圆心
  radius: 50000.0, // 半径
  extrudedHeight: 50000.0, // 拉伸高度
  vertexFormat: Cesium.VertexFormat.POSITION_AND_NORMAL, // 顶点格式, 这里有顶点和法线
})

const geometry02 = new Cesium.RectangleGeometry({
  vertexFormat: Cesium.VertexFormat.POSITION_AND_NORMAL, // 顶点格式, 这里有顶点和法线
  rectangle: Cesium.Rectangle.fromDegrees(115.5, 39.5, 116.5, 40.5), // 矩形范围
  height: 0.0, // 高度
  extrudedHeight: 50000.0, // 拉伸高度
})

// 02 创建几何体的实例
const instance01 = new Cesium.GeometryInstance({
  
  geometry: geometry01, // 几何体
  attributes: {
    color: Cesium.ColorGeometryInstanceAttribute.fromColor(Cesium.Color.RED), // 颜色
  },
})

const instance02 = new Cesium.GeometryInstance({
  id: "rectangle01",
  geometry: geometry02, // 几何体
  attributes: {
    color: Cesium.ColorGeometryInstanceAttribute.fromColor(Cesium.Color.BLUE), // 颜色
  },
})

//03 创建几何体的渲染对象
const primitive = new Cesium.Primitive({
  geometryInstances: [instance01, instance02], // 几何体实例数组
  appearance: new Cesium.PerInstanceColorAppearance({
    flat: false,
  })
})
viewer.scene.primitives.add(primitive) // 添加到场景中
viewer.scene.render()
// instance02.attributes.color = Cesium.ColorGeometryInstanceAttribute.fromColor(Cesium.Color.GREEN) // 修改颜色为绿色
setTimeout(() => {
  const attribute = primitive.getGeometryInstanceAttributes("rectangle01")
  attribute.color = Cesium.ColorGeometryInstanceAttribute.toValue(Cesium.Color.GREEN) // 修改颜色为绿色
}, 500);
