...
const viewer = new Viewer("app", {
  ...
  terrainProvider: await createWorldTerrainAsync({
    requestVertexNormals: true, // 是否请求顶点法线数据，默认为 false，设置为 true 后可以获得更好的光照效果，但会增加加载时间和内存使用
    requestWaterMask: true, // 是否请求水面掩码数据，默认为 false，设置为 true 后可以获得更好的水面效果，但会增加加载时间和内存使用
  }), // 不使用地形 — 平滑椭球体地球
