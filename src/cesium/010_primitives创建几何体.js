...
// 使用entities来创建一个基础的矩形

// const rectangleEntity = viewer.entities.add({
//   name: "My Rectangle",
//   position: Cartesian3.fromDegrees(116.0, 39.5),
//   rectangle: { // rectangle这个好像会和地形有关系?
//     coordinates: Rectangle.fromDegrees(115.5, 39.0, 116.5, 40.0),
//     material: Cesium.Color.RED.withAlpha(0.5),
//     height: 0, // 设置为0 和地形分离开
//     outline: true,
//     outlineColor: Cesium.Color.BLACK,
//   }
// })
// 01 创建顶点
const planeGeometry = new Cesium.RectangleGeometry({
  vertexFormat: Cesium.VertexFormat.POSITION_AND_NORMAL,
  rectangle: Cesium.Rectangle.fromDegrees(115.5, 39.0, 116.5, 40.0),
...
const planeInstance = new Cesium.GeometryInstance({
  ...
  attributes: {
    color: Cesium.ColorGeometryInstanceAttribute.fromColor(Cesium.Color.RED.withAlpha(0.5)), // 设置颜色为红色，透明度为0.5
  }
})
// 03 设置几何体的外观
const planePrimitive = new Cesium.Primitive({
  ...
  appearance: new Cesium.PerInstanceColorAppearance({
    flat: true, // 是否使用平面着色器，设置为 true 后颜色不会受到光照影响
  }),
  asynchronous: false, // 是否异步加载，设置为 false 后会阻塞渲染线程，可能会导致卡顿
})
// 04 添加到场景中
