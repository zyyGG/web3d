...
const center = Cesium.Cartesian3.fromDegrees(115.75, 39.75, 2750.0);
const modelMatrix = Cesium.Transforms.eastNorthUpToFixedFrame(center);
const cube = new Cesium.Primitive({
  geometryInstances: new Cesium.GeometryInstance({
    geometry: new Cesium.RectangleGeometry({
      vertexFormat: Cesium.VertexFormat.POSITION_AND_ST,
      rectangle: Cesium.Rectangle.fromDegrees(115.75, 39.75, 118.85, 42.85),
    }),
  }),
...
viewer.scene.primitives.add(cube) // 添加到场景中
// viewer.scene.render()

// viewer.camera.flyTo({
//   destination: Cartesian3.fromDegrees(-75.59777, 40.03883, 3000000.0),
// })
// viewer.zoomTo(cube, new Cesium.HeadingPitchRange(0, -CesiumMath.PI_OVER_TWO, 500));
// viewer.camera.flyToBoundingSphere(cube.boundingSphere, {
//   duration: 3,
//   offset: new Cesium.HeadingPitchRange(0, -CesiumMath.PI_OVER_TWO, 500),
// });