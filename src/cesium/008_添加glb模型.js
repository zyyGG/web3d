...
const model = await viewer.entities.add({
  name: "cube001",
  position: Cartesian3.fromDegrees(116.391193, 39.9067, 30),
  model: {
    uri: "/models/cubes/cube.glb",
    // minimumPixelSize:128, // 模型最小像素大小，单位像素，默认值为 0，表示不限制最小像素大小
    // 设置轮廓
    silhouetteColor: Cesium.Color.RED, // 轮廓颜色，默认值为 Color.BLACK
    silhouetteSize: 2, // 轮廓大小，单位像素，默认值为 0，表示不显示轮廓
    // enableShowOutline: true, // 是否启用轮廓，默认值为 false
  }
})
viewer.camera.position = Cartesian3.fromDegrees(116.391193, 39.9067, 100);
