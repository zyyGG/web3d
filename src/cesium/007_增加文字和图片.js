...
const label = {
  position: Cartesian3.fromDegrees(116.391193, 39.906761, 100),
  label: {
    text: "天安门广场",
...
viewer.entities.add({
  position: Cartesian3.fromDegrees(116.391193, 39.906761, 80),
  point: {
    pixelSize: 10,
    color: Color.RED,
...
viewer.camera.flyTo({
  destination: Cartesian3.fromDegrees(116.391193, 39.906761, 200),
  duration: 3,// 3秒飞行到指定位置
})
